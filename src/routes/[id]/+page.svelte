...
<div class="flex flex-row mx-auto mt-3 gap-x-4">
	<figure class="max-w-md">
		<img src={data.comic.cover_url} alt="Cover img" class="rounded-xl" />
	</figure>
	<div class="card bg-base-100 shadow-xl">
		<div class="card-body">
            <h2 class="text-3xl font-semibold">{data.comic.title}</h2>
            <div class="leading-4">
                <h3 class="text-lg"><span class="font-bold">Series:</span> {data.comic.serie.serie_name}</h3>
                <h3 class="text-lg"><span class="font-bold">Volume:</span> {data.comic.volume}</h3>
                <h3 class="text-lg"><span class="font-bold">Collection:</span> {data.comic.serie.collection.name}</h3>
                <h3 class="text-lg"><span class="font-bold">Editor:</span> {data.comic.serie.collection.editor.name}</h3>
            </div>
            ...
            <div class="leading-4">
                ...
                <h3 class="text-lg"><span class="font-bold">Release date:</span> {data.comic.release_date}</h3>
